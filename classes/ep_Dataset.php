...
class ep_Dataset extends ep_Api {
	  ...
	  public function keyword($keyword){
		...
		public function find_all( $limit = null, $offset = null, $return_objects=true ){
		  ...
		  $this->performance = isset($data['performance']) ? $data['performance'] : false;
		  $this->q = isset($data['query']) ? $data['query'] : false;
			$this->items_class = isset($data['items_class']) ? $data['items_class'] : false;
			$this->items = isset($data['items']) ? $data['items'] : false;
			$this->items_found_rows = isset($data['items_found_rows']) ? $data['items_found_rows'] : false;
			$this->limit = isset($data['limit']) ? $data['limit'] : false;
			$this->mode = isset($data['mode']) ? $data['mode'] : false;
			...
			if( isset( $data['_mode'] ) && $data['_mode']=='search' ) {
			  ...
			  return $this->items;
				...
				if( $this->respect_limit && $this->mode=='DBF' ) {
